        ...
        <div className="grid gap-12 md:grid-cols-5">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              />
              <span className="font-display text-xl font-bold text-primarytext group-hover:-foreground  transition-colors">
                        MH Digital Edge
                    </span>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-background/70 max-w-sm">
              ...
              since 2014. Let's build something amazing together.
            </p>
        ...
        >
          <div className="text-center md:text-left">
            <p className="text-sm text-background/60">
              © 2026 MH Digital Edge. All rights reserved.
            </p>
          </div>
